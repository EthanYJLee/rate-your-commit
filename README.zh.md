...
- [x] **0.0.1** — 界面设计、架构设计、许可证/治理、README、初始仓库脚手架搭建
- [x] **v1.0** — 身份映射 + Git/工单系统集成 + 个人绩效卡片（GitHub 连接器）
- [x] **v1.1** — 新增 GitLab / Jira / Linear 连接器
- [x] **v1.2** — 邮箱/密码登录、基于角色的访问控制（admin/member）、CSRF 防护（当前版本）
- [x] **v1.3** — 团队层级结构、看板风险提醒、薪酬等级确定（finalize）工作流
- [ ] v2.0 — 同行评价（360°）模块
- [ ] v2.1 — 项目维度绩效汇总界面、薪酬等级两级审批工作流（PM→人事）
